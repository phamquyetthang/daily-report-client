    ...
    <div className="max-w-full">
      ...
      >
        <div className="inline-flex">
          ...
          >
            <img className="w-8 h-8 rounded-full" src="/assets/logo.png" alt="Avatar" />
          </a>
        </div>
        <div className="flex h-full md:flex-1">
          ...
          <div className="flex sm:ml-6 sm:items-center">
            <div className="relative flex items-center h-full ml-3">
              ...
              <div
                className="absolute top-0 right-0 w-56 mt-20 origin-top-right transform rounded-xl"
              >
                <div
                ...
                >
                  <a className="block px-4 py-3 text-gray-700 hover:text-gray-800">
                  ...
                  <div className="py-1">
                    <div className="block px-4 py-1">
                      <span
                        className="inline-block px-2 my-1 -ml-1 text-xs font-medium leading-5 text-gray-600 bg-gray-200 rounded"
                      >Developer</span
                      >
                    </div>
                    <a
